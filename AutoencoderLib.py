...
def assemble_AAE(dim_latente:int, img_shape:tuple, enc_model:Model=build_dense_encoder, dec_model:Model=build_dense_decoder, disc_model:Model = build_discriminator, 
